                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => MovieAPIPage(
                                        title: boxoffice[index]['title']
                                            .toString(),
                                        bannerurl:
                                            "https://image.tmdb.org/t/p/w500" +
                                                boxoffice[index]
                                                    ['backdrop_path'],
                                        rating: boxoffice[index]['vote_average']
                                            .toString(),
                                        ratingcount: boxoffice[index]
                                                ['vote_count']
                                            .toString(),
                                        release: boxoffice[index]
                                            ['release_date'],
                                        streamtime: boxoffice[index]
                                                ['popularity']
                                            .toString(),
                                        summary: boxoffice[index]
                                            ['overview'])));
                          },
                          child: Container(
                            width: 330,
                              ...
                              children: [
                                ...
                                Container(
                                  child: Column(
                                    children: [
                                      Text(
                                        boxoffice[index]['title'] != null
                                            ? boxoffice[index]['title']
                                            : 'Title Loading',
                                        style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 18,
